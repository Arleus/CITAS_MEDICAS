...
<html lang="en">
	...
	<body>
						...
						echo "<div class='row'>";
							echo "<div class='col-lg-12'>";
								echo "<div class='alert alert-danger alert-dismissable'>";
									...
									echo " <i class='fa fa-info-circle'></i>  <strong>Estimado(a), faltan completar sus datos.</strong>" ;
								echo "  </div>";
							echo "</div>";
							// <!-- notification end -->
							...
							?>
							<!-- notification end -->
							<h2>Hola <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?>. Reserva tu cita hoy mismo!</h2>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© DuckCodes </a></p>
            </div>
        </div>
		<!-- footer end -->
