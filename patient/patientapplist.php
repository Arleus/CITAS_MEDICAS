...
echo "<h1>Tu lista de citas </h1>";
echo "</div>";
echo "<div class='panel panel-primary'>";
echo "<div class='panel-heading'>Lista de las citas</div>";
echo "<div class='panel-body'>";
echo "<table class='table table-hover'>";
echo "<thead>";
echo "<tr>";
echo "<th>ID</th>";
echo "<th>Numero Clínico </th>";
echo "<th>Apellido </th>";
echo "<th>Dia seleccionado </th>";
echo "<th>Fecha de la Cita </th>";
echo "<th>Hora Inicio </th>";
echo "<th>Hora a Finalizar </th>";
echo "<th>Imprimir </th>";
echo "</tr>";
echo "</thead>";
