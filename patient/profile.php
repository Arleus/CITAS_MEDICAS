												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<div class="radio">
																<label><input type="radio" name="patientMaritialStatus" value="widowed" <?php echo $widowed; ?>>Viudo(a)</label>
															</div>
														</td>
													</tr>
													<!-- radio button end -->
													...
													<tr>
														...
														<td>
															<div class="radio">
																<label><input type="radio" name="patientGender" value="male" <?php echo $male; ?>>Masculo</label>
															</div>
															<div class="radio">
																<label><input type="radio" name="patientGender" value="female" <?php echo $female; ?>>Femenino</label>
															</div>
														</td>
													</tr>
													<!-- radio button end -->
