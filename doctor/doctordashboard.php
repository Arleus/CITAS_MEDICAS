                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="Número Clínico" disabled></th>
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Comienza" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Fin" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Progreso" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Completo" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Borrar" disabled></th>
                                </tr>
                            </thead>
